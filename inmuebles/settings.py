...
"""
Django settings for inmobiliariaProject project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-_ns2=e7-k7ul67%7t1nl)hs=@oc$(wm3+p54*39$goha)7tg@&')
...
if(DEBUG == False):
    ALLOWED_HOSTS = [
        'grupo4-inmueblesms.herokuapp.com',
        '127.0.0.1'
    ]
